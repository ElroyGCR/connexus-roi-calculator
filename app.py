...
with col1:
    st.markdown(metric_block("💰 Net Monthly Savings", suffix="$", net_savings), unsafe_allow_html=True)
with col2:
    st.markdown(metric_block("🧾 Break-even Period", payback_days, suffix=" days"), unsafe_allow_html=True)
with col3:
    st.markdown(metric_block("📈 ROI on Operating Cost (Monthly)", suffix="%", roi_percent), unsafe_allow_html=True)
with col4:
...
with col1:
    st.markdown(metric_block("🧠 Production Dollar Savings", suffix="$", production_dollar_savings), unsafe_allow_html=True)
with col2:
    st.markdown(metric_block("🛒 Upsell Dollar Savings", suffix="$", upsell_dollar_savings, color="#1f77b4", border="#1f77b4"), unsafe_allow_html=True)
with col3:
    st.markdown(metric_block("🎯 Total Monthly Value", suffix="$", net_savings + indirect_savings, color="#FFD700", border="#FFD700"), unsafe_allow_html=True)
